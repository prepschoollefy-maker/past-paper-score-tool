...
export default function DataValidator() {
    ...
    const runValidation = useCallback(async () => {
        ...
        for (let batchIdx = 0; batchIdx < batches.length; batchIdx++) {
            ...
            try {
                const res = await fetch('/api/admin/validate-data', {
                    method: 'POST',
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                <Link href="/admin-panel" className="text-slate-400 hover:text-white transition-colors">
            ...
            <div className="bg-slate-800 rounded-xl border border-slate-700 p-6">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <h2 className="font-semibold text-white mb-1">1. CSVファイルをアップロード</h2>
                        <p className="text-sm text-slate-400 mb-3">検証したいCSVファイルを選択してください</p>
                        <input
                            type="file"
                            accept=".csv"
