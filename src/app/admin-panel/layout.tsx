...
import { LogOut, Database, Upload, Users, LayoutDashboard, Shield, BarChart3, SearchCheck } from 'lucide-react'
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <nav className="hidden md:flex items-center gap-6">
                            ...
                            <Link href="/admin-panel/data-validator" className="flex items-center gap-2 text-slate-300 hover:text-orange-400 transition-colors">
            ...
            <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-slate-800 border-t border-slate-700 z-50 shadow-lg">
                <div className="flex justify-around py-3">
                    ...
                    >
                        ...
                        <span className="text-xs font-medium">検証</span>
                    </Link>
                </div>
            </nav>
